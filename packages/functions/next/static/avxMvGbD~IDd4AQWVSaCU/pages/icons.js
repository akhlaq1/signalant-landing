(window.webpackJsonp = window.webpackJsonp || []).push([
  ...
  {
    483: function(e, a, t) {
      __NEXT_REGISTER_PAGE('/icons', function() {
        return (e.exports = t(513)), { page: e.exports.default };
      });
    },
    513: function(e, a, t) {
      'use strict';
        ...
        i = {
          ...
          colorStyles: {
            primary: {
              ...
              '&:hover': { color: s.primaryHover, borderColor: s.primaryHover },
            },
            secondary: {
              color: s.secondary,
              borderColor: s.secondary,
              '&:hover': {
                color: s.secondaryHover,
                borderColor: s.secondaryHover,
              },
            },
            warning: {
              color: s.yellow,
              borderColor: s.yellow,
              '&:hover': { color: s.yellowHover, borderColor: s.yellowHover },
            },
            error: {
              color: s.secondaryHover,
              borderColor: s.secondaryHover,
              '&:hover': { color: s.secondary, borderColor: s.secondary },
            },
            primaryWithBg: {
              color: s.white,
              ...
              borderColor: s.primary,
              '&:hover': {
                backgroundColor: s.primaryHover,
                borderColor: s.primaryHover,
              },
            },
            secondaryWithBg: {
              color: s.white,
              ...
              borderColor: s.secondary,
              '&:hover': {
                backgroundColor: s.secondaryHover,
                borderColor: s.secondaryHover,
              },
            },
            warningWithBg: {
              ...
              borderColor: s.yellow,
              '&:hover': {
                backgroundColor: s.yellowHover,
                borderColor: s.yellowHover,
              },
            },
            errorWithBg: {
              color: s.white,
          ...
          buttonStyles: {
            textButton: {
              ...
              padding: 0,
              height: 'auto',
              backgroundColor: ''.concat(s.transparent),
            },
            outlined: {
              borderWidth: '1px',
              borderStyle: 'solid',
            ...
            c.a.createElement(
              ...
              c.a.createElement(
                ...
                c.a.createElement(
                  'div',
                  null,
                  c.a.createElement('div', { className: 'title' }, 'Examples:'),
                  c.a.createElement(
                    'div',
                    { className: 'image' },
                    c.a.createElement(
